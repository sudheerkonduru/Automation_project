...
import { FaBuilding, FaTachometerAlt, FaUsers, FaUser, FaCalendarAlt, FaMoneyBillWave, FaCogs, FaAccessibleIcon, FaUniversalAccess, FaLockOpen, FaKey, FaShieldAlt, FaClock } from "react-icons/fa";

const TemporaryAdminSidebar = () => {
  return (
